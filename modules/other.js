...
function RdAMPplusMapToRun(number) {
    var map;
    if (Rdshoulddopraid) {
        var praidzone = getPageSetting('RdAMPraidzone');
        var raidzone = getPageSetting('RdAMPraidraid');
...
function RdAMPshouldrunmap(number) {
    var go = false;
    if (Rdshoulddopraid) {
        var praidzone = getPageSetting('RdAMPraidzone');
        var raidzone = getPageSetting('RdAMPraidraid');
...
function RdAMPpcheckmap(number) {
    if (Rdshoulddopraid) {
        var praidzone = getPageSetting('RdAMPraidzone');
        var raidzone = getPageSetting('RdAMPraidraid');
...
function RdAMPplusPres(number) {
    document.getElementById("biomeAdvMapsSelect").value = "Plentiful";
    document.getElementById("advExtraLevelSelect").value = RdAMPplusMapToRun(number);
    document.getElementById("advSpecialSelect").value = "p";
    document.getElementById("lootAdvMapsRange").value = 0;
    document.getElementById("difficultyAdvMapsRange").value = 9;
    document.getElementById("sizeAdvMapsRange").value = 9;
...
function RdAMPplusPresfragmax(number) {
    document.getElementById("biomeAdvMapsSelect").value = "Plentiful";
    document.getElementById("advExtraLevelSelect").value = RdAMPplusMapToRun(number);
    document.getElementById("advSpecialSelect").value = "p";
    document.getElementById("lootAdvMapsRange").value = 0;
...
function RdAMPplusPresfragmin(number) {
    document.getElementById("biomeAdvMapsSelect").value = "Plentiful";
    document.getElementById("advExtraLevelSelect").value = RdAMPplusMapToRun(number);
    document.getElementById("advSpecialSelect").value = "p";
    document.getElementById("lootAdvMapsRange").value = 0;
...
function RdAMPfrag() {
    ...
    if (Rdshoulddopraid) {
        ...
        if (Rgetequips(raidzones, false)) {
            if (getPageSetting('RdAMPraidfrag') == 1) cost += RdAMPplusPresfragmin(0);
            else if (getPageSetting('RdAMPraidfrag') == 2) cost += RdAMPplusPresfragmax(0);
        }
        if (Rgetequips((raidzones - 1), false)) {
            if (getPageSetting('RdAMPraidfrag') == 1) cost += RdAMPplusPresfragmin(1);
            else if (getPageSetting('RdAMPraidfrag') == 2) cost += RdAMPplusPresfragmax(1);
        }
        if (Rgetequips((raidzones - 2), false)) {
            if (getPageSetting('RdAMPraidfrag') == 1) cost += RdAMPplusPresfragmin(2);
            else if (getPageSetting('RdAMPraidfrag') == 2) cost += RdAMPplusPresfragmax(2);
        }
        if (Rgetequips((raidzones - 3), false)) {
            if (getPageSetting('RdAMPraidfrag') == 1) cost += RdAMPplusPresfragmin(3);
            else if (getPageSetting('RdAMPraidfrag') == 2) cost += RdAMPplusPresfragmax(3);
        }
        if (Rgetequips((raidzones - 4), false)) {
            if (getPageSetting('RdAMPraidfrag') == 1) cost += RdAMPplusPresfragmin(4);
            else if (getPageSetting('RdAMPraidfrag') == 2) cost += RdAMPplusPresfragmax(4);
        }
